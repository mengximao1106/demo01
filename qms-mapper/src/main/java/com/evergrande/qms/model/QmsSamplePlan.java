 ...
 * FileName: SamplePlan
 * Author:   liaowenlong
 * Date:     2018-07-23 13:49
 * Description: 抽样计划表,与qms_sample_plan对应
 */
...
public class QmsSamplePlan implements Serializable {
    /**
     * id=主键
     */
     ...
     * 抽样人id
     */
    @ApiModelProperty(value = "抽样人姓名",name = "sampleUserName")
     ...
     * 计划明细
     */
    @ApiModelProperty(value = "计划明细",name = "qmsSamplePlanDetailList")
    private List<QmsSamplePlanDetail> qmsSamplePlanDetailList;
    /**
     * 供应商名称
     */
     ...
     * 临时字段初检计划ID
     */
    @ApiModelProperty(value = "临时字段初检计划ID", name = "planNumber")
