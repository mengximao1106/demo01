...
@NoArgsConstructor
@Data
@ApiModel(value = "SamplePlanDetailVO对象", description= "SamplePlanDetailVO")
public class SampleInspectPlanDetailVO implements Serializable {
    /**
     * id主键
     */
     ...
     * 抽样前附件
     */
    @ApiModelProperty(value = "抽样前附件", name = "ossSamplingBefore")
    private List<QmsOssAttachmentAppVO> ossSamplingBefore;
    /**
     * 抽样中附件
     */
    @ApiModelProperty(value = "抽样中附件", name = "ossSamplingMiddle")
    private List<QmsOssAttachmentAppVO> ossSamplingMiddle;
    /**
     * 抽样后附件
     */
    @ApiModelProperty(value = "抽样后附件", name = "ossSamplingAfter")
    private List<QmsOssAttachmentAppVO> ossSamplingAfter;
    /**
     * 取消附件
     */
    @ApiModelProperty(value = "取消附件", name = "ossSamplingCancel")
    private List<QmsOssAttachmentAppVO> ossSamplingCancel;
    /**
     * 备样附件
     */
    @ApiModelProperty(value = "备样附件", name = "ossSamplingBackups")
    private List<QmsOssAttachmentAppVO> ossSamplingBackups;
}
